...
bool radarInstance::contain_script(octaveScript* script)
{
    return radarModule::contain_script(script);
}


void  radarInstance::remove_script(octaveScript* script)
{
    radarModule::remove_script(script);
}
